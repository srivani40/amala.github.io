    ...
    $.fn.countdown = function (options) {
        ...
        return this.each(function () {
            ...
            function getCurrentCountDown() {
                ...
                return { days: formatNumber(Math.max(0,(-1*days)), true), hours: formatNumber(Math.max(0, (-1*hours)), false), minutes: formatNumber(Math.max(0, (-1*minutes)), false), seconds: formatNumber(Math.max(0, (-1*seconds)), false) };
            }
